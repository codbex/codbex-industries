...
var dao = require("codbex-industries/gen/dao/Industries/Industry");
var http = require("codbex-industries/gen/api/utils/http");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-industries/gen/api/Industry.js/" + entity.Id);
